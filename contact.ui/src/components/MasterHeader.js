...
class MasterHeader extends React.Component{
    ...
    render(){
        ...
        <Link className="navbar-brand" to="../index-2.html" ><img src="../assets/images/logo.png" alt="" /></Link>
            ...
            <div className="collapse navbar-collapse " id="navbarSupportedContent">
                <ul className="navbar-nav ml-auto navbar-right-top">
                    ...
                    <li className="nav-item dropdown notification">
                        <button className="nav-link nav-icons link-button"  id="navbarDropdownMenuLink1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i className="fas fa-fw fa-bell"></i> <span className="indicator"></span></button>
                    ...
                    <li className="nav-item dropdown nav-user">
                        <button className="nav-link nav-user-img link-button" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/avatar-1.jpg" alt="" className="user-avatar-md rounded-circle" /></button>
                        <div className="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                            ...
                            <button className="dropdown-item link-button" ><i className="fas fa-user mr-2"></i>Account</button>
                            <button className="dropdown-item link-button" ><i className="fas fa-cog mr-2"></i>Setting</button>
                            <button className="dropdown-item link-button" ><i className="fas fa-power-off mr-2"></i>Logout</button>
                        </div>
                    </li>
                </ul>
            </div>
